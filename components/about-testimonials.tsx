...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    company: "기웃기옷",
    quote:
      "협업 과정에서 팀원들의 의견을 경청하고 존중하면서도, 자신의 생각은 논리적이고 설득력 있게 잘 전달할 수 있는 팀원입니다. \n또한 항상 책임감 있게 자신의 역할을 수행할 뿐만 아니라, 필요할 때는 다른 팀원들도 적극적으로 도와주는 모습 덕분에 함께 개발하는 과정이 즐거웠던 팀원이었습니다.",
  },
]
